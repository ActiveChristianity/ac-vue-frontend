...
const gql = {
    types,
    queries: Object.assign({}, auth.queries, blog.queries, cms.queries, other.queries),
    mutations: Object.assign({}, auth.mutations, blog.mutations, cms.mutations, forms.mutations)
};
export default gql;
